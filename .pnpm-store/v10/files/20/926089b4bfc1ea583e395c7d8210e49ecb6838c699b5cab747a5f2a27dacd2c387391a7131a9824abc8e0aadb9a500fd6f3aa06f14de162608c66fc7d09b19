...
export declare class RefBase extends TrackedFinalizer {
    private _refcount;
...
export declare interface TrackedFinalizer extends Finalizer, RefTracker {
}

export declare class TrackedFinalizer extends Finalizer {
    static finalizeAll(list: RefTracker): void;
    link(list: RefTracker): void;
    unlink(): void;
